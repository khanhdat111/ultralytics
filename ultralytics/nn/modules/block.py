...
#     def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, cbam=True):
#         """Initializes a CSP bottleneck with 2 convolutions and n Bottleneck blocks for faster processing."""
#         super().__init__()
#         self.c = int(c2 * e)  # hidden channels
#         self.cv1 = Conv(c1, 2 * self.c, 1, 1)    
...
#         self.use_cbam = cbam
#         if self.use_cbam:
#             self.cbam = CBAM(2 * self.c, reduction= 16)
...
#         self.use_cbam = cbam
#         if self.use_cbam:
#             self.cbam = CBAM(2 * c_, reduction= 16)
...
#         self.m = nn.ModuleList(
#             C3k(self.c, self.c, 2, shortcut, g, e=0.5, k=3, cbam=cbam) if c3k else Bottleneck(self.c, self.c, shortcut, g) for _ in range(n)
#         )
